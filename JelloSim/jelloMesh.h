...
public:
    ...
    virtual ~JelloMesh();
	void setKDKSValues();
	void outputVertices(int& i_frame);
...
public:
    ...
    static double RK4_g_structuralKs;
    static double RK4_g_structuralKd;
    static double RK4_g_shearKs;
    static double RK4_g_shearKd;
    static double RK4_g_bendKs;
    static double RK4_g_bendKd;
    static double RK4_g_penaltyKs;
    static double RK4_g_penaltyKd;

	static double EU_g_structuralKs;
    static double EU_g_structuralKd;
    static double EU_g_shearKs;
    static double EU_g_shearKd;
    static double EU_g_bendKs;
    static double EU_g_bendKd;
    static double EU_g_penaltyKs;
    static double EU_g_penaltyKd;

	static double MP_g_structuralKs;
    static double MP_g_structuralKd;
    static double MP_g_shearKs;
    static double MP_g_shearKd;
    static double MP_g_bendKs;
    static double MP_g_bendKd;
    static double MP_g_penaltyKs;
    static double MP_g_penaltyKd;

	static int gridSizeX;
	static int gridSizeY;
	static int gridSizeZ;
